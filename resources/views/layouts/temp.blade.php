      ...
      >
        ...
        >
          <div class="navbar-nav font-weight-bold mx-auto py-0">
            ...
            <a href="http://127.0.0.1:8000/classes" class="nav-item nav-link">Classes</a>
            
            <a href="http://127.0.0.1:8000/gallery" class="nav-item nav-link">Gallery</a>
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu rounded-0 m-0">
                <a href="http://127.0.0.1:8000/ourblog" class="dropdown-item">Blog Grid</a>
                <a href="http://127.0.0.1:8000/blogdetails" class="dropdown-item">Blog Detail</a>
              </div>
            </div>
            <a href="http://127.0.0.1:8000/contact" class="nav-item nav-link">Contact</a>
          </div>
          <a href="http://127.0.0.1:8000/book-seat" class="btn btn-primary px-3">Join Class</a>
        </div>
      </nav>
    </div>
    <!-- Navbar End -->
